...
# class strong_img_aug:
#     def __init__(self, flag_using_ct_aug=False):
#         self.flag_using_ct_aug = flag_using_ct_aug
#
#     def __call__(self, img):
...
def main():
     # 打开图像文件
     img_path = '/home/chicken/Code/AugSeg-main1/2008_001643.jpg'  # 替换为你的图片路径
     original_img = Image.open(img_path)
     # 创建增强器实例
     autocontrast_img = img_aug_posterize(original_img, scale=[4, 8])

     autocontrast_img.save(
        '/home/chicken/Code/AugSeg-main1/posterize_aug.jpg'
     )
     #augmenter = strong_img_aug(flag_using_ct_aug=False)
     ...
     # 保存结果（可选）
     #augmented_img.save('/home/chicken/Code/AugSeg-main1/aug_pictures/augmented_image.jpg')
