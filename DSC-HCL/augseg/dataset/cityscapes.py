...
class city_dset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        if self.transform_strong is None:
            ...
            image_strong1 = self.transform_strong(image_weak)
            # print("="*100)
            ...
            image_strong1, _ = self.trf_normalize(image_strong1, label)
            # print(index, image_weak.shape, image_strong.shape,label.shape)

            return index, image_weak, image_strong, image_strong1, label
...
def build_additional_strong_transform(cfg):
    ...
    strong_img_aug = img_trsform.strong_img_aug(strong_aug_nums, flag_using_random_num=flag_use_rand_num)
