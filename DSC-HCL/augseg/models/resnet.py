...
# HOME_NAME = "SSS"
# cur_path_file = os.getcwd()
# lst_dir = cur_path_file.split(os.path.sep)
...
model_urls = {
    ...
    # "resnet101": os.path.join(CODE_DIR, "pretrained", "resnet101.pth"),
...
class ResNet(nn.Module):
    def __init__(
        ...
        # self.use_attention = use_attention  # 存储注意力标志
        ...
        #     self.attn1 = DW_CBAM(64 * expansion)
        #     self.attn2 = DW_CBAM(128 * expansion)
        #     self.attn3 = DW_CBAM(256 * expansion)
        #     self.attn4 = DW_CBAM(512 * expansion)
...
def resnet18(pretrained=True, pretrain_model_url=None, **kwargs):
...
def resnet34(pretrained=True, pretrain_model_url=None, **kwargs):
...
def resnet50(pretrained=True, pretrain_model_url=None, **kwargs):
...
def resnet101(pretrained=True, pretrain_model_url=None, **kwargs):
...
def resnet152(pretrained=True, pretrain_model_url=None, **kwargs):
